...
public class GlobalReservationExceptionHandler {
	...
	public ResponseEntity<String> handleGuestNotFoundException(ReservationNotFoundException ex){
		return new ResponseEntity<String>(ex.getMessage(),HttpStatus.NOT_FOUND);
	}
	
	@ExceptionHandler(ReservationAlreadyExistException.class)
	public ResponseEntity<String> handleReservationAlreadyExistException(ReservationAlreadyExistException ex){
